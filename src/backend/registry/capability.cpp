...
namespace sim { namespace eng {
    size_t enumerate_capabilities(eng::Capability* out, size_t cap) {
        eng::Capability list[9];
        size_t n = 0;
        list[n++] = eng::Capability{eng::Backend::Native, eng::DataLayout::SoA, "native_soa"};
        list[n++] = eng::Capability{eng::Backend::Native, eng::DataLayout::AoS, "native_aos"};
        ...
        list[n++] = eng::Capability{eng::Backend::AVX2, eng::DataLayout::AoS, "avx2_aos"};
        ...
        list[n++] = eng::Capability{eng::Backend::TBB, eng::DataLayout::AoS, "tbb_aos"};
