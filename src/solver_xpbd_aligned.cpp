...
void xpbd_step_aligned_common(ClothAligned& cloth,
...
void xpbd_step_native_aligned(ClothAligned& cloth, float dt, const XPBDParams& params) {
    ...
    xpbd_step_aligned_common(cloth, settings, params, sequential_loop);
}
...
void xpbd_step_tbb_aligned(ClothAligned& cloth, float dt, const XPBDParams& params) {
    ...
    xpbd_step_aligned_common(cloth, settings, params, parallel_loop);
#else
