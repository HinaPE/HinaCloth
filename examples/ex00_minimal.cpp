...
int main(){
    ...
    uint32_t nx=16, ny=16; float dx=0.05f;
    ...
    Param gpy{"gravity_y", ParamType::F32, {.f32=-9.8f}}; Parameters params{&gpy, 1};
    ...
    auto r = create(bd); if (r.status != Status::Ok) { std::printf("ex00: create failed\n"); return 1; }
    Solver* s = r.value;
